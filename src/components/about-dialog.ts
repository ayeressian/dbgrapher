      ...
      <dbg-dialog title="About" showClose ?show=${this.#open} @dbg-on-close="${this.#close}" @dbg-on-escape="${this.#close}">
        <div slot="body">
          <p>
            ...
            If you like relational databases and have knowledge or wish to learn more about typescript, webcomponent, litelement, redux, webpack, karma, jasmine, playwright and much more
            you should consider to contribute to this <a target="_blank" and rel="noopener noreferrer" href="https://github.com/ayeressian/dbgrapher">project</a>.
