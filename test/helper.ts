...
export const createElement = async (elementType: string, attrs: {[key in string]: string} = {}, noUpdate = false): Promise<LitElement> => {
...
export function initComponentTest(param: initComponentTestParameters): Promise<LitElement> {
